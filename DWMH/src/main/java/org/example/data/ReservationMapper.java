...
public class ReservationMapper implements RowMapper<Reservation>  {
    ...
    public Reservation mapRow(ResultSet rs, int rowNum) throws SQLException {
        //Building the basic fields of a reservation. Adding a Location and Guest will be more complex
        ...
        //Compose a Guest. Guest object will be added to reservation
        User guest = new User();
        ...
        //Compose a Host. Host object will be added to location, and location will be added to reservation.
        User host = new User();
        ...
        //Compose a Location. Location object to be added to reservation
